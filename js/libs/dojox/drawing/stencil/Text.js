//>>built
define("dojox/drawing/stencil/Text",["dojo","dijit","dojox"],function(_1,_2,_3){
_1.provide("dojox.drawing.stencil.Text");
...
_1.forEach(this._textArray,function(_8,i){
...
var _a=_1.create("span",{innerHTML:_9,id:"foo"},document.body);
var sz=1;
_1.style(_a,"fontSize",sz+"px");
var _b=30;
while(_1.marginBox(_a).w<w){
sz++;
_1.style(_a,"fontSize",sz+"px");
if(_b--<=0){
break;
