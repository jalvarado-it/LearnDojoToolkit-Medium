//>>built
define("dojox/drawing/stencil/Image",["dojo","dijit","dojox"],function(_1,_2,_3){
_1.provide("dojox.drawing.stencil.Image");
...
var _9=_1.create("img",{src:this.data.src},_1.body());
var _a=_1.connect(_9,"error",this,function(){
_1.disconnect(c);
_1.disconnect(_a);
console.error("Error loading image:",this.data.src);
console.warn("Error image:",this.data);
});
var c=_1.connect(_9,"load",this,function(){
var _b=_1.marginBox(_9);
