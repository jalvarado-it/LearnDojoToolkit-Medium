//>>built
define("dojox/drawing/stencil/_Base",["dojo","dijit","dojox","dojo/require!dojo/fx/easing"],function(_1,_2,_3){
_1.provide("dojox.drawing.stencil._Base");
...
var ms=_11.ms||20;
var _13=_11.ease||_1.fx.easing.linear;
var _14=_11.steps;
...
var _15=true;
var sp,ep;
if(_1.isArray(_11.start)){
sp=_11.start;
ep=_11.end;
}else{
if(_1.isObject(_11.start)){
sp=_11.start;
ep=_11.end;
_15=false;
}else{
...
var ts=this.textSelected||{},o,nm,_18,_19=_1.toJson(n),_1a=_1.toJson(t);
...
if(_1c||_1a!=_1.toJson(t)||_19!=_1.toJson(n)){
...
var _22=_1.clone(this.points),_23=false;
...
_1.forEach(_2e,_1.disconnect,_1);
