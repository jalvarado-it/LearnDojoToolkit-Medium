//>>built
define("dojox/drawing/ui/Toolbar",["dojo","dijit","dojox","dojo/require!dojox/drawing/library/icons"],function(_1,_2,_3){
_1.provide("dojox.drawing.ui.Toolbar");
_1.require("dojox.drawing.library.icons");
_1.declare("dojox.drawing.ui.Toolbar",[],{constructor:function(_4,_5){
...
var _6=_1.marginBox(_5);
this.width=_6.w;
this.height=_6.h;
this.strSelected=_1.attr(_5,"selected");
this.strTools=_1.attr(_5,"tools");
this.strPlugs=_1.attr(_5,"plugs");
this._mixprops(["padding","margin","size","radius"],_5);
this.toolDrawing=new _3.drawing.Drawing({mode:"ui"},_5);
this.orient=_1.attr(_5,"orient");
}
...
_1.disconnect(c);
this.drawing=_3.drawing.getRegistered("drawing",_1.attr(_5,"drawingId"));
this.makeButtons();
if(!this.strSelected&&this.drawing.defaults.clickMode){
...
_1.map(_14,function(p){
return _1.trim(p);
});
}
_1.forEach(_14,function(p){
var t=_1.trim(p);
...
_1.forEach(_1c,function(p){
this[p]=_1d.tagName?_1.attr(_1d,p)===null?this[p]:_1.attr(_1d,p):_1d[p]===undefined?this[p]:_1d[p];
},this);
}});
});
