//>>built
define("dojox/drawing/annotations/Angle",["dojo","dijit","dojox"],function(_1,_2,_3){
_1.provide("dojox.drawing.annotations.Angle");
...
_1.style(_5,{left:x+"px",top:y+"px",align:pt.align});
...
_1.fadeOut({node:this._angleNode,duration:500,onEnd:function(_7){
_1.destroy(_7);
}}).play();
