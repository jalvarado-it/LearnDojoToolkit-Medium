//>>built
define("dojox/drawing/manager/Canvas",["dojo","dijit","dojox"],function(_1,_2,_3){
_1.provide("dojox.drawing.manager.Canvas");
(function(){
_3.drawing.manager.Canvas=_3.drawing.util.oo.declare(function(_4){
_1.mixin(this,_4);
var _5=_1.contentBox(this.srcRefNode);
...
var _e=_1.contentBox(_d).h;
_1.style(_d,"overflow","scroll");
var _f=_e-_1.contentBox(_d).h;
_1.destroy(_d);
