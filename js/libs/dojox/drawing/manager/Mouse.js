//>>built
define("dojox/drawing/manager/Mouse",["dojo","dijit","dojox"],function(_1,_2,_3){
_1.provide("dojox.drawing.manager.Mouse");
...
var c;
var _6=false;
_1.connect(this.container,"rightclick",this,function(_7){
console.warn("RIGHTCLICK");
});
_1.connect(document.body,"mousedown",this,function(_8){
});
_1.connect(this.container,"mousedown",this,function(_9){
this.down(_9);
if(_9.button!=_1.mouseButtons.RIGHT){
_6=true;
c=_1.connect(document,"mousemove",this,"drag");
}
});
_1.connect(document,"mouseup",this,function(_a){
_1.disconnect(c);
_6=false;
this.up(_a);
});
_1.connect(document,"mousemove",this,function(_b){
if(!_6){
this.move(_b);
}
});
_1.connect(this.keys,"onEsc",this,function(_c){
this._dragged=false;
});
},setCanvas:function(){
var _d=_1.coords(this.container.parentNode);
this.origin=_1.clone(_d);
...
if(!_1f){
_1.style(this.container,"cursor",_1e);
}else{
_1.style(_1f,"cursor",_1e);
}
}});
});
