//>>built
define("dojox/drawing/manager/Anchors",["dojo","dijit","dojox"],function(_1,_2,_3){
_1.provide("dojox.drawing.manager.Anchors");
...
this.items[_f.id]._cons=[_1.connect(a,"onRenderStencil",this,"onRenderStencil"),_1.connect(a,"reset",this,"onReset"),_1.connect(a,"onAnchorUp",this,"onAnchorUp"),_1.connect(a,"onAnchorDown",this,"onAnchorDown"),_1.connect(a,"onAnchorDrag",this,"onAnchorDrag"),_1.connect(a,"onTransformPoint",this,"onTransformPoint"),_1.connect(_f,"onChangeStyle",this,"onChangeStyle")];
...
_1.forEach(this.items[_f.id].anchors,function(_10){
_1.forEach(this.items[_f.id].anchors,function(a){
if(_10.id!=a.id){
...
_1.forEach(this.items[_11.id].anchors,function(a){
a.destroy();
});
_1.forEach(this.items[_11.id]._cons,_1.disconnect,_1);
