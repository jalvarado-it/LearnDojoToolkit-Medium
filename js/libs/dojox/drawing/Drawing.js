//>>built
define("dojox/drawing/Drawing",["dojo","dijit","dojox"],function(_1,_2,_3){
_1.provide("dojox.drawing.Drawing");
(function(){
var _4=false;
_1.declare("dojox.drawing.Drawing",[],{ready:false,mode:"",width:0,height:0,constructor:function(_5,_6){
var _7=_1.attr(_6,"defaults");
if(_7){
_3.drawing.defaults=_1.getObject(_7);
}
this.defaults=_3.drawing.defaults;
this.id=_6.id;
_3.drawing.register(this,"drawing");
this.mode=(_5.mode||_1.attr(_6,"mode")||"").toLowerCase();
var _8=_1.contentBox(_6);
this.width=_8.w;
this.height=_8.h;
...
_2.registry={objs:{},add:function(_9){
this.objs[_9.id]=_9;
}};
_2.byId=function(id){
return _2.registry.objs[id];
};
_2.registry.add(this);
}
...
this.canvas=new _3.drawing.manager.Canvas({srcRefNode:this.domNode,util:this.util,mouse:this.mouse,callback:_1.hitch(this,"onSurfaceReady")});
this.initPlugins();
},resize:function(_d){
_d&&_1.style(this.domNode,{width:_d.w+"px",height:_d.h+"px"});
if(!this.canvas){
this._createCanvas();
}else{
if(_d){
...
return _1.mixin({container:ui&&!_10?this.canvas.overlay.createGroup():this.canvas.surface.createGroup(),util:this.util,keys:this.keys,mouse:this.mouse,drawing:this,drawingType:ui&&!_10?"ui":"stencil",style:this.defaults.copy()},_e||{});
...
var _12=_1.mixin({util:this.util,keys:this.keys,mouse:this.mouse,drawing:this,stencils:this.stencils,anchors:this.anchors,canvas:this.canvas},p.options||{});
