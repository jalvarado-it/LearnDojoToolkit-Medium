//>>built
define("dojox/drawing/tools/TextBlock",["dojo","dijit","dojox","dojo/require!dojox/drawing/stencil/Text"],function(_1,_2,_3){
_1.provide("dojox.drawing.tools.TextBlock");
...
_1.style(_4,{height:_a?"auto":this._lineHeight+"px",fontSize:(this.textSize/this.mouse.zoom)+"px",fontFamily:this.style.text.family});
_4.innerHTML=_a||"";
return _4;
...
var _b=_2.byId("greekPalette");
var _c=_b==undefined?false:true;
if(_c){
_1.mixin(_b,{_pushChangeTo:_4,_textBlock:this});
}
...
_1.forEach([_d,_e,_f,kc4],function(c){
_1.disconnect(c);
});
...
_d=_1.connect(_4,"keyup",this,function(evt){
if(_1.trim(_4.innerHTML)&&!_11){
_1.style(_4,"height","auto");
_11=true;
}else{
if(_1.trim(_4.innerHTML).length<2&&_11){
_1.style(_4,"height",this._lineHeight+"px");
_11=false;
}
}
if(!this._blockExec){
...
_e=_1.connect(_4,"keydown",this,function(evt){
if(evt.keyCode==13||evt.keyCode==27){
_1.stopEvent(evt);
}
if(evt.keyCode==220){
...
_f=_1.connect(document,"mouseup",this,function(evt){
