//>>built
define("dojox/drawing/tools/custom/Axes",["dojo","dijit","dojox","dojo/require!dojox/drawing/stencil/Path"],function(_1,_2,_3){
_1.provide("dojox.drawing.tools.custom.Axes");
...
var _5={};
_1.mixin(_5,_4);
_1.mixin(_5,{container:this.container.createGroup(),style:this.style,showAngle:false,label:null});
...
this.labelX=new _3.drawing.annotations.Label(_1.mixin(_8,{labelPosition:this.setLabelX}));
this.labelY=new _3.drawing.annotations.Label(_1.mixin(_8,{labelPosition:this.setLabelY}));
if(this.style.zAxisEnabled){
this.labelZ=new _3.drawing.annotations.Label(_1.mixin(_8,{labelPosition:this.setLabelZ}));
}
},setLabelX:function(){
