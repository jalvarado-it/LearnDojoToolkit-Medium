//>>built
define("dojox/drawing/plugins/tools/Pan",["dojo","dijit","dojox","dojo/require!dojox/drawing/plugins/_Plugin"],function(_1,_2,_3){
_1.provide("dojox.drawing.plugins.tools.Pan");
_1.require("dojox.drawing.plugins._Plugin");
...
_5&&clearTimeout(_5);
_5=setTimeout(_1.hitch(this,"checkBounds"),200);
});
...
this._timer=setInterval(_1.hitch(this,function(_a){
