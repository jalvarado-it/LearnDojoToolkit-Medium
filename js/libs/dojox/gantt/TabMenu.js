//>>built
define("dojox/gantt/TabMenu",["dojo","dijit","dojox","dojo/require!dijit/dijit,dijit/Menu,dijit/Dialog,dijit/form/NumberSpinner,dijit/form/Button,dijit/form/CheckBox,dijit/form/DateTextBox,dijit/form/TimeTextBox,dojo/date/locale,dijit/form/Form,dojo/parser"],function(_1,_2,_3){
_1.provide("dojox.gantt.TabMenu");
_1.require("dijit.dijit");
_1.require("dijit.Menu");
_1.require("dijit.Dialog");
_1.require("dijit.form.NumberSpinner");
_1.require("dijit.form.Button");
_1.require("dijit.form.CheckBox");
_1.require("dijit.form.DateTextBox");
_1.require("dijit.form.TimeTextBox");
_1.require("dojo.date.locale");
