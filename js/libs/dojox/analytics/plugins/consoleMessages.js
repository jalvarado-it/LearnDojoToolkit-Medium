...
consoleMessages.addData=_1.hitch(_2,"addData","consoleMessages");
...
if(console[_5[i]]){
_4.after(console,_5[i],_1.hitch(consoleMessages,"addData",_5[i]),true);
}else{
console[_5[i]]=_1.hitch(consoleMessages,"addData",_5[i]);
}
}
