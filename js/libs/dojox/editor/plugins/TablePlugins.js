...
this._myListeners=[_1.connect(this.editorDomNode,"mouseup",this.editor,"onClick"),_1.connect(this.editor,"onDisplayChanged",this,"checkAvailable"),_1.connect(this.editor,"onBlur",this,"checkAvailable"),_1.connect(this.editor,"_saveSelection",this,function(){
this._savedTableInfo=this.getTableInfo();
}),_1.connect(this.editor,"_restoreSelection",this,function(){
...
var tr,_c,td,_d,_e,_f,_10,_11,o;
...
o={tbl:_e,td:td,tr:tr,trs:_c,tds:_d,rows:_c.length,cols:_f,tdIndex:_10,trIndex:_11,colIndex:_10%_f};
}else{
o={};
}
this.tableData=o;
...
this._strings=_1.i18n.getLocalization("dojox.editor.plugins","TableDialog");
var _1f=this._strings[str+"Title"]||this._strings[str+"Label"];
if(!_1f){
if(str=="colorTableCell"){
_1f=this._strings["backgroundColor"].slice(0,-1);
}else{
var ns=[];
...
var e=this.editor;
var _21=_1.withGlobal(e.window,"getSelectedHtml",_2._editor.selection,[null]);
var str=_21.match(/id="*\w*"*/g);
...
var _22=e.byId(id);
if(_22&&_22.tagName.toLowerCase()=="td"){
_20.push(_22);
}
},this);
if(!_20.length){
...
var _23=r.startContainer;
while(_23&&_23!=e.editNode&&_23!=e.document){
if(_23.nodeType===1){
...
this.connect(this,"setEditor",function(_24){
_24.onLoadDeferred.addCallback(_1.hitch(this,function(){
...
var _25=new _2.Menu({targetNodeIds:[this.editor.iframe]});
var _26=_1.i18n.getLocalization("dojox.editor.plugins","TableDialog",this.lang);
_25.addChild(new _2.MenuItem({label:_26.selectTableLabel,onClick:_1.hitch(this,"selectTable")}));
_25.addChild(new _2.MenuSeparator());
_25.addChild(new _2.MenuItem({label:_26.insertTableRowBeforeLabel,onClick:_1.hitch(this,"modTable","insertTableRowBefore")}));
_25.addChild(new _2.MenuItem({label:_26.insertTableRowAfterLabel,onClick:_1.hitch(this,"modTable","insertTableRowAfter")}));
_25.addChild(new _2.MenuItem({label:_26.insertTableColumnBeforeLabel,onClick:_1.hitch(this,"modTable","insertTableColumnBefore")}));
_25.addChild(new _2.MenuItem({label:_26.insertTableColumnAfterLabel,onClick:_1.hitch(this,"modTable","insertTableColumnAfter")}));
_25.addChild(new _2.MenuSeparator());
_25.addChild(new _2.MenuItem({label:_26.deleteTableRowLabel,onClick:_1.hitch(this,"modTable","deleteTableRow")}));
_25.addChild(new _2.MenuItem({label:_26.deleteTableColumnLabel,onClick:_1.hitch(this,"modTable","deleteTableColumn")}));
this.menu=_25;
}});
...
w.show();
this.connect(w,"onSetTable",function(_27){
var o=this.getTableInfo();
_1.attr(o.td,"bgcolor",_27);
});
}});
...
var _28=_1.i18n.getLocalization("dojox.editor.plugins","TableDialog");
_1.mixin(this,_28);
},startup:function(){
if(!this._started){
this.inherited(arguments);
...
},_setValueAttr:function(_29,_2a){
this._colorPicker.set("value",_29,_2a);
},_getValueAttr:function(){
return this._colorPicker.get("value");
},setColor:function(_2b){
this._colorPicker.setColor(_2b,false);
...
var _2d=new _3.editor.plugins._CellColorDropDown();
_1.body().appendChild(_2d.domNode);
_2d.startup();
this.dropDown=_2d.dialog;
this.connect(_2d,"onChange",function(_2e){
this.editor.focus();
this.modTable(null,_2e);
});
this.connect(_2d,"onCancel",function(){
this.editor.focus();
});
this.connect(_2d.dialog,"onOpen",function(){
var o=this.getTableInfo(),tds=this.getSelectedCells(o.tbl);
if(tds&&tds.length>0){
var t=tds[0]==this.lastObject?tds[0]:tds[tds.length-1],_2f;
while(t&&t!==this.editor.document&&((_2f=_1.style(t,"backgroundColor"))=="transparent"||_2f.indexOf("rgba")==0)){
t=t.parentNode;
}
