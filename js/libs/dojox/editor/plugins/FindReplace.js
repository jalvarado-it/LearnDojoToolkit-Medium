...
var _2c=_2b.duplicate();
var _2d=win.getSelection();
var _2e=_2d.getRangeAt(0);
var _2f=doc.selection?doc.selection.createRange():null;
if(_2f){
if(_29){
_2b.setEndPoint("EndToStart",_2f);
}else{
_2b.setEndPoint("StartToEnd",_2f);
}
}else{
if(this._bookmark){
var _30=win.getSelection().toString();
_2b.moveToBookmark(this._bookmark);
if(_2b.text!=_30){
_2b=_2c.duplicate();
this._bookmark=null;
}else{
if(_29){
_2c.setEndPoint("EndToStart",_2b);
_2b=_2c.duplicate();
}else{
_2c.setEndPoint("StartToEnd",_2b);
_2b=_2c.duplicate();
}
}
}
...
_2a=_2b.findText(txt,_2b.text.length,_31);
if(_2a){
_2b.select();
this._bookmark=_2b.getBookmark();
}
}
}
}
return _2a;
},_filterRegexp:function(_32,_33){
var rxp="";
var c=null;
...
var _34=o.args.name.toLowerCase();
if(_34==="findreplace"){
