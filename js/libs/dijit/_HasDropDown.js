//>>built
define("dijit/_HasDropDown",["dojo/_base/declare","dojo/_base/Deferred","dojo/_base/event","dojo/dom","dojo/dom-attr","dojo/dom-class","dojo/dom-geometry","dojo/dom-style","dojo/has","dojo/keys","dojo/_base/lang","dojo/touch","dojo/_base/window","./registry","./focus","./popup","./_FocusMixin","./Viewport"],function(_1,_2,_3,_4,_5,_6,_7,_8,_9,_a,_b,_c,_d,_e,_f,_10,_11,_12){
...
if(!this._opened&&(e.keyCode==_a.DOWN_ARROW||((e.keyCode==_a.ENTER||e.keyCode==dojo.keys.SPACE)&&((_17.tagName||"").toLowerCase()!=="input"||(_17.type&&_17.type.toLowerCase()!=="text"))))){
...
var _18=_f.curNode&&this.dropDown&&_4.isDescendant(_f.curNode,this.dropDown.domNode);
...
if(_20==-1){
var _21=_12.getEffectiveBox(this.ownerDocument),_22=_7.position(_1d,false);
_20=Math.floor(Math.max(_22.y,_21.h-(_22.y+_22.h)));
}
_10.moveOffScreen(_1b);
if(_1b.startup&&!_1b._started){
_1b.startup();
}
var mb=_7.getMarginSize(_1c);
var _23=(_20&&mb.h>_20);
_8.set(_1c,{overflow:_23?"auto":"visible"});
if(_23){
mb.h=_20;
if("w" in mb){
mb.w+=16;
...
var _24=_10.open({parent:this,popup:_1b,around:_1d,orient:this.dropDownPosition,onExecute:function(){
